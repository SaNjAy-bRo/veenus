          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="space-y-4 text-base text-slate-300">
              ...
              <div className="flex items-center gap-4 pt-4 justify-center md:justify-start">
                <a href="https://wa.me/917337330044" target="_blank" rel="noopener noreferrer" className="bg-[#25D366]/10 p-2 rounded-full text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all duration-300">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-[#E1306C]/10 p-2 rounded-full text-[#E1306C] hover:bg-[#E1306C] hover:text-white transition-all duration-300">
                  <Instagram size={20} />
                </a>
